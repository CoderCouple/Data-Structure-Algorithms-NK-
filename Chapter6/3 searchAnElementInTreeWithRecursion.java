...
public class BinaryTree {
	...
	public static boolean searchAnElementInTreeWithRecursion(TNode node, int element) {
		...
		return searchAnElementInTreeWithRecursion(node.leftChild, element) || searchAnElementInTreeWithRecursion(node.rightChild, element);
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("Is Search Element Present : " + searchAnElementInTree(bt.root, 100));
	}

...
public class BinaryTree {
	...
	public static void printNodeAncestors(TNode array[], int index) {
	...
	public static void printAllAncestors(TNode node) {

		if (node == null)
			return;

		TNode array[] = new TNode[256];
		int size = 0;

		TNode currentNode = node;
		while (currentNode != null) {
			array[size++] = currentNode;
			currentNode = currentNode.leftChild;
		}

		while (size > 0) {
			int ofset = 1;
			TNode n = array[size - 1];
			if (n.rightChild != null) {
			...
			size = size - ofset;
			printNodeAncestors(array, size);
		}

	}

	public static void zigzagTraversal(TNode node) {
	...
	public static TNode getCommonAncestor(TNode node, int n1, int n2) {
		...
		TNode left = getCommonAncestor(node.leftChild, n1, n2);
		TNode right = getCommonAncestor(node.rightChild, n1, n2);
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * bt2.add(100); bt2.add(200); bt2.add(50); bt2.add(80); bt2.add(40);
		 * bt2.add(250); bt2.add(150); bt2.add(225); bt2.add(500); bt2.add(3);
		 * bt2.add(45);
		 * 
		...
		// System.out.println("Are the two binary trees mirror of each other : "
		// + isMirror(bt1.root, bt2.root));

		// printAllAncestors(bt1.root);

		//zigzagTraversal(bt1.root);
		
		System.out.println(bt1.getCommonAncestor(bt1.root, 800, 225).data);

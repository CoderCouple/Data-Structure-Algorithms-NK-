...
public class MyLinkedList {
	...
	public static void main(String[] args) {
		...
		// insertNodeInSortedLinkedList(l1, 0);
		// System.out.println("Value of the middle Node : " +
		// displayLinkedListFromTheEndUsingRecursion(l1.head));
		
		Node ptr=mergeSortedLinkedLists(l1.head, l2.head);
